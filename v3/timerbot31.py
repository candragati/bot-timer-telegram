...
import requests
from config import *
from modul import me,bio,afk,qotd,langdetect
...
class bot_timer():
    def __init__(self):
        ...
        dp.add_handler(MessageHandler(Filters.text, langdetect.echo))
        dp.add_handler(MessageHandler(Filters.all, afk.echo_afk))
